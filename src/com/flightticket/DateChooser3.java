...
public class DateChooser3 extends JPanel{
    ...
    //提交日期
    private void commit(){
        changeTicket.aircraft_date=sdf.format(select.getTime());
        showDate.setText(sdf.format(select.getTime()));
        hidePanel();
        changeTicket.button_1.setText(sdf.format(select.getTime()));
        jf.dispose();
    }
    ...
    public static void main(String[] args) {
        final DateChooser3 mp=new DateChooser3();
        jf=new JFrame("");
